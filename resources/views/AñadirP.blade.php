...
@section('title')
    <title>
        Clinident / Añadir Paciente</title>
@endsection
@section('css-externo')
@endsection
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form action="{{ route('AnadirP.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label title="Seleccione su Genero">Genero <span
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label title="Seleccione una foto donde se distinga su rostro">Foto</label><span
                                            class="text-danger">*</span>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" maxlength="30" placeholder="Ingrese La Ocupacion"
                                            name="ocupacion" type="text" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <form>
                                        <div class="col-lg-8 offset-lg-2">
                                            <h4 class=" text-center" style="padding: 2rem 0; color:rgb(8, 76, 136)">
                                                Antecedentes Medicos</h4>
                                            ...
                                            <tbody>
                                                @foreach ($alergias as $alergia)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input placeholder="Indique metodo alternativo usado"
                                                                maxlength="100" value="Descripción" type="text"
                                                                name="{{ $alergia['desc'] }}"style="border-style: hidden; text-align: center;">
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                {{-- <tr>
                                                    ...
                                                    <td><input placeholder="Indique metodo alternativo usado"
                                                            maxlength="100" value="Descripción" type="text"
                                                            name="desc_alergia_p"style="border-style: hidden; text-align: center;">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group gender-select">
                                                            ...
                                                            <div class="form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input type="radio" name='alergia_medicamento'
                                                    ...
                                                    <td><input placeholder="Indique medicamento y/o componentes"
                                                            maxlength="100" value="Descripción" type="text"
                                                            name="desc_alergia_m"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group gender-select">
                                                            ...
                                                            <div class="form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input type="radio" name="trat_actual"
                                                                        value="Si" class="form-check-input"
                                                                        required>Si esta bajo tratamiento
                                                                </label>
                                                            </div>
                                                            <br>
                                                            <div class="form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input type="radio" name="trat_actual"
                                                                        value="No" class="form-check-input">No Esta
                                                                    bajo tratamiento
                                                                </label>
                                                            </div>
                                                    </td>
                                                    <td><input placeholder="Indique tipo de tratamiento y medicamentos"
                                                            maxlength="100" value="Descripción" type="text"
                                                            name="desc_trat_actual"
                                                            style="border-style: hidden; text-align: center;"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input placeholder="Indique etapa de Gravidez" type="text"
                                                            maxlength="100" value="Descripción" name="desc_gravidez"
                                                            style="border-style: hidden; text-align: center;"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group gender-select">
                                                            ...
                                                            <div class="form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input type="radio" name="hemorragia"
                                                                        value="Si" class="form-check-input"
                                                                        required>Si
                                                                </label>
                                                            </div>
                                                    ...
                                                    <td><input placeholder="Indique motivos" type="text"
                                                            maxlength="100" value="Descripción" name="desc_hemorragia"
                                                            style="border-style: hidden; text-align: center;"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input placeholder="Indique contexto que provoca desmayos"
                                                            maxlength="100" value="Descripción" type="text"
                                                            name="desc_desmayos"
                                                            style="border-style: hidden; text-align: center;"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input placeholder="Indique serveridad" type="text"
                                                            maxlength="100" name="desc_asma" value="Descripción"
                                                            style="border-style: hidden; text-align: center;"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input placeholder="Indique Tipo"type="text" maxlength="100"
                                                            name="desc_diabetes" value="Descripción"
                                                            style="border-style: hidden; text-align: center;"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group gender-select">
                                                            ...
                                                            <div class="form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input type="radio" name="hipertension"
                                                                        value="Si" class="form-check-input"
                                                                        required>Si
                                                                </label>
                                                            </div>
                                                    ...
                                                    <td><input placeholder="Ultimo registro de tension" maxlength="100"
                                                            type="text" value="Descripción" name="desc_hipertension"
                                                            style="border-style: hidden; text-align: center;"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input placeholder="Indique motivos y frecuencia" maxlength="100"
                                                            type="text" value="Descripción" name="desc_epilepsia"
                                                            style="border-style: hidden; text-align: center;"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group gender-select">
                                                            ...
                                                            <div class="form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input type="radio" name="cancer_actual"
                                                                        value="Si" class="form-check-input"
                                                                        required>Si
                                                                </label>
                                                            </div>
                                                    ...
                                                    <td><input placeholder="Indique Tipo de Cancer"type="text"
                                                            maxlength="100" value="Descripción" name="desc_cancer_actual"
                                                            style="border-style: hidden; text-align: center;"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group gender-select">
                                                            ...
                                                            <div class="form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input type="radio" name="cancer_pasado"
                                                                        value="Si" class="form-check-input"
                                                                        required>Si
                                                                </label>
                                                            </div>
                                                    ...
                                                    <td><input placeholder="Indique Tipo de Cancer"type="text"
                                                            maxlength="100" value="Descripción" name="desc_cancer_pasado"
                                                            style="border-style: hidden; text-align: center;"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input placeholder="Fecha de prueba  positiva" maxlength="100"
                                                            value="Descripción" type="text" name="desc_vih"
                                                            style="border-style: hidden; text-align: center;"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input placeholder="Nombre de la condicion"type="text"
                                                            maxlength="100" value="Descripción"
                                                            name="desc_inmunodeficiente"
                                                            style="border-style: hidden; text-align: center;"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input placeholder="Desde Hace Cuanto?"type="text" maxlength="100"
                                                            value="Descripción" name="desc_fumador"
                                                            style="border-style: hidden; text-align: center;"></td>
                            ...
                            <div class="col-lg-8 offset-lg-2">
                                ...
                                <div class="m-t-20 text-center">
                                    <button type="submit" class="btn btn-primary submit-btn" maxlength="100"
                                        style="list-style: none; color: aliceblue;">Registrar Paciente</button>
                                </div>
                            </div>
