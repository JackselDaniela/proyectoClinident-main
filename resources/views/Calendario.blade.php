                            ...
                            <div class='col-md-6'>
                                <div class='form-group'>
                                    ...
                                    <input title="Ingrese el documento de identidad del Doctor" class='form-control'
                                        type='number' max='99000000' placeholder="Ejm: 12000000" name='doctor' required />
                                </div>
                            </div>
                            <div class='col-md-6'>
                                <div class='form-group'>
                    ...
                    <form action='{{ url('/') }}' method="POST" id="formEditar">
                        ...
                        <div class="row">
                            ...
                            <div class='col-md-6'>
                                <div class='form-group'>
                                    <label>Hora Hasta</label>
                                    <input class='form-control' type='time' name='fin'  id="fin_" required />
                                </div>
                            </div>
                            <div class='col-md-6'>
                                <div class='form-group'>
                                    <label>Fecha</label>
                                    <input class='form-control' type='date' name='fecha' id="fecha_" required />
                                </div>
                            </div>
