              ...
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <div class="input-group">
                    <input class="form-control" id="date-init" name="date_init" placeholder="Fecha Inicio" type="date"
            ...
            <div class="col-sm-4 col-md-4">
              <div class="form-group row">
                <div class="col-md-12">
                  Hasta
                  <div class="input-group">
                    <input class="form-control" id="date-fin" name="date_fin" placeholder="Fecha Fin" type="date"
                      value="{{ $date_fin ?? date('Y-m-d') }}" min="{{ date('Y-m-d') }}" max="{{ date('Y-m-d') }}">
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div>
                    ...
                    <table class="table table-bordered">
                      <tbody>
                        <tr>
                          <td><strong>Sueldo neto</strong> <span class="float-right">${{ $total_doctor ?? 0 }}</span>
                          </td>
                        </tr>
