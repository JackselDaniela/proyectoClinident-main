                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="date-init" name="date_init" placeholder="Fecha Inicio" type="date" value="{{ $date_init ?? date('Y-m-d') }}" max="{{ date('Y-m-d') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group row">
                            <div class="col-md-12">
                                Hasta
                                <div class="input-group">
                                    <input class="form-control" id="date-fin" name="date_fin" placeholder="Fecha Fin" type="date" value="{{ $date_fin ?? date('Y-m-d') }}" min="{{ date('Y-m-d') }}" max="{{ date('Y-m-d') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 col-md-3">
                        <div class="form-group row">
                            <div class="col-md-12">
                                Doctor
                                <div class="input-group">
                                    <input class="form-control" placeholder="Doc. Identidad" name="doctor_cedula" type="text" value="{{ isset($doctor) ? $doctor->persona->doc_identidad : '' }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 m-b-20">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <h5 class="mb-0"><strong>{{ $doctor->persona->nombre }} {{ $doctor->persona->apellido }}</strong></h5>
                                    </li>
                            ...
                            <div class="col-sm-6">
                                <div>
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            <tr>
                                                <td><strong>Acumulado Clinica</strong> <span class="float-right">${{ $total_hospital ?? 0 }}</span></td>
                                            </tr>
                                ...
                                <div>
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            <tr>
                                                <td><strong>Sueldo neto</strong> <span class="float-right">${{ $total_doctor ?? 0 }}</span></td>
                                            </tr>
...
@section('js-externo')
    ...
    <script>
        ...
        inputDateInit.onchange = (e) => {
            ...
            const monthMin = Number(dateMin.getUTCMonth() + 1) > 10 ? dateMin.getUTCMonth() + 1 : "0" + String(dateMin.getUTCMonth() + 1)
