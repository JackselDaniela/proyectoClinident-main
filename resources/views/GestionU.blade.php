                        ...
                        <form action="{{ route('GestionU.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="nom_empresa" placeholder="Indique" type="text"
                                            value="" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="website" value="https://www.example.com"
                                            type="text" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-3">
                                    <div class="form-group">
                                        <label>Estado</label>
                                        <input class="form-control " name="estado" placeholder="Indique" type="text"
                                            required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control " name="municipio" placeholder="Indique" type="text"
                                            required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-3">
                                    <div class="form-group">
                                        <label>Ciudad</label>
                                        <input class="form-control" name="ciudad" placeholder="Indique" type="text"
                                            required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="parroquia" placeholder="Indique" type="text"
                                            required>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="direccion"
                                            value="3864 Quiet Valley Lane, Sherman Oaks, CA, 91403" type="text" required>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Correo</label>
                                        <input class="form-control" name="correo" placeholder="example@example.com"
                                            type="email" required>
                                    </div>
                                </div>
                            </div>
