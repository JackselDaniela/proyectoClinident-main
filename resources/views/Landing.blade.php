    ...
    <body>
        ...
        <header id="header" class="fixed-top">
            <div class="container d-flex align-items-center">
                ...
                <button id="add-register" class="appointment-btn scrollto" data-toggle="modal"
                    style="margin-left:18rem!important; color:#fff; border:none!important">Iniciar Sesión</button>
            </div>
        </header><!-- End Header -->
        <!-- Modal -->

        <div class="modal fade" id="modal-data" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <button type="button" class="btn close" data-dismiss="modal" aria-label="Close" id="btn-close"
                            ...
                            <div class="container-login100">
                                <div class="wrap-login100">
                                    <form method="POST" action="{{ route('login.autenticar') }}">
                                        ...
                                        <div class="row mb-3">
                                            <a href="{{ route('password.request') }}" class="mx-auto">¿Olvidó su
                                                contraseña?</a>
                                        </div>
        ...
        <main id="main">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-6 d-flex justify-content-center align-items-stretch position-relative">
                            <img class="col-xl-5 col-lg-6 d-flex justify-content-center  position-relative"
                                style="width: 60rem!important" src="{{ asset('landing/assets/img/depar5.jpg') }}"
                                alt="">
                        </div>
                        ...
                        <div
                            ...
                            <div class="icon-box">
                                ...
                                <p class="description">Ya no necesitas trabajar con diferentes herramientas, puedes
                                    automatizar todo en una sola herramienta.</p>
                            </div>

                            <div class="icon-box">
                                <div class="icon"><i class="fa fa-book"></i></div>
                                <h4 class="title"><a href="">Organizada</a></h4>
                                <p class="description">Administra los procesos de una forma ordenada facilitando la
                                    ejecución de las tareas. </p>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                            <div class="icon-box">
                                ...
                                <p>El software administrativo puede ayudarlo a tomar mejores decisiones sobre su clínica
                                    dental al brindarle información sobre su desempeño financiero, los pacientes y las
                                    tendencias de tratamiento.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
                            <div class="icon-box">
                                ...
                                <p>El software administrativo puede ayudar a proteger los datos de sus pacientes
                                    proporcionando acceso y almacenamiento seguros.</p>
                            </div>
                        </div>
                    ...
                    <div class="row gy-4">
                        <div class="col-lg-3">
                            <ul class="nav nav-tabs flex-column">
                                <li class="nav-item">
                                    <a class="nav-link active show" data-bs-toggle="tab" href="#tab-1">Odontología
                                        general</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#tab-3">Patología maxilofacial y
                                        oral</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#tab-4">Cirugía oral y
                                        maxilofacial</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active show" id="tab-1">
                                    <div class="row gy-4">
                                        <div class="col-lg-8 details order-2 order-lg-1">
                                            ...
                                            <p class="fst-italic">La odontología general proporciona los conocimientos
                                                fundamentales para aplicar tratamientos básicos con los que mejorar la salud
                                                bucal. También tiene una parte preventiva, pues proporciona recomendaciones
                                                sobre higiene y salud bucodental que ayudan a evitar la aparición de otras
                                                enfermedades más graves que ya necesitaría atender un odontólogo más
                                                especializado.</p>
                                        </div>
                                        <div class="col-lg-4 text-center order-1 order-lg-2">
                                            <img style="height: 250px;"
                                                src="{{ asset('landing/assets/img/odontologiage.jpg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane" id="tab-2">
                                    <div class="row gy-4">
                                        <div class="col-lg-8 details order-2 order-lg-1">
                                            <h3>Endodoncia</h3>
                                            <p class="fst-italic">Especialidad en la pulpa dental (el nervio del diente) en
                                                todos sus aspectos, abarcando el diagnóstico, prevención y tratamiento de la
                                                misma.
                                                Gracias a esta especialidad se pueden mantener las piezas dentales del
                                                paciente aun cuando su nervio está dañando, ya que hoy en día se ha mejorado
                                                mucho la calidad de este tipo de tratamientos. Por citar algunos de los
                                                principales tratamientos, hablamos de la “terapia del conducto radicular”,
                                                el retratamiento endodóntico o directamente la cirugía.
                                            </p>
                                        </div>
                                        <div class="col-lg-4 text-center order-1 order-lg-2">
                                            <img src="{{ asset('landing/assets/img/endodoncia.jpg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane" id="tab-3">
                                    <div class="row gy-4">
                                        <div class="col-lg-8 details order-2 order-lg-1">
                                            ...
                                            <p class="fst-italic">La patología maxilofacial y oral es la rama que realiza
                                                el diagnóstico y estudio de las enfermedades de la cavidad oral, mandíbulas
                                                (maxilares) y estructuras relacionadas. Tanto en sus causas como en su
                                                manera de afectar al paciente.
                                                Pero no solo en la boca y sus estructuras relacionadas (glándulas salivales,
                                                articulaciones temporomandibulares… incluso la piel alrededor de la boca),
                                                un odontólogo especializado en patología maxilofacial y oral también puede
                                                llegar a diagnosticar y tratar enfermedades en cuello y cabeza.
                                            </p>
                                        </div>
                                        <div class="col-lg-4 text-center order-1 order-lg-2">
                                            <img src="{{ asset('landing/assets/img/patologia.jpg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane" id="tab-4">
                                    <div class="row gy-4">
                                        <div class="col-lg-8 details order-2 order-lg-1">
                                            ...
                                            <p class="fst-italic">Un especialista en cirugía oral y maxilofacial se encarga
                                                directamente de intervenir en enfermedades y lesiones en la cabeza, cuello,
                                                cara, mandíbulas y tejidos duros y blandos de la boca. También en el caso de
                                                que se haya nacido con defectos que afecten a cualquiera de estas áreas. Su
                                                campo de acción es tan amplio que va desde intervenciones pequeñas como
                                                extraer un diente, ya mencionada, a otras mucho más complicadas que incluso
                                                requieren intervenciones junto a otros especialistas médicos</p>
                                        </div>
                                        <div class="col-lg-4 text-center order-1 order-lg-2">
                                            <img src="{{ asset('landing/assets/img/cirugia.jpg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane" id="tab-5">
                                    <div class="row gy-4">
                                        <div class="col-lg-8 details order-2 order-lg-1">
                                            <h3>Ortodoncia</h3>
                                            <p class="fst-italic">La especialidad de ortodoncia abarca no sólo la
                                                corrección de las mandíbulas y los dientes mal posicionados – alineándolos
                                                correctamente para modificar la mordida y que haya una correcta oclusión.
                                                También se ocupa del diagnóstico y, muy importante, de la prevención.
                                                Uno de los motivos por los que es una rama de la odontología muy demandada
                                                es que es de las mejor pagadas. Por no hablar de que actualmente, quién no
                                                ha llevado o lleva una ortodoncia.</p>
                                        </div>
                                        <div class="col-lg-4 text-center order-1 order-lg-2">
                                            <img src="{{ asset('landing/assets/img/ortodoncia.jpg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
            ...
            <section id="doctors" class="doctors">
                <div class="container">
                    ...
                    <div class="section-title">
                        <h2>Doctores</h2>
                        <p>Estos son solo algunos de los doctores de la clínica dental que utilizan la aplicación de
                            software para mejorar la atención al paciente.</p>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-4 mt-lg-0">
                            <div class="member d-flex align-items-start">
                                <div class="pic"><img src="{{ asset('landing/assets/img/doctors/doctors-33.jpg') }}"
                                        class="img-fluid" alt=""></div>
                                <div class="member-info">
                                    <h4>Daniel Díaz</h4>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="gallery-item">
                                <a href="{{ asset('landing/assets/img/gallery/3.jpg') }}" class="galelry-lightbox">
                                    <img src="{{ asset('landing/assets/img/gallery/3.jpg') }}" alt=""
                                        class="img-fluid">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="gallery-item">
                                <a href="{{ asset('landing/assets/img/gallery/4.jpg') }}" class="galelry-lightbox">
                                    <img src="{{ asset('landing/assets/img/gallery/4.jpg') }}" alt=""
                                        class="img-fluid">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="gallery-item">
                                <a href="{{ asset('landing/assets/img/gallery/5.jpg') }}" class="galelry-lightbox">
                                    <img src="{{ asset('landing/assets/img/gallery/5.jpg') }}" alt=""
                                        class="img-fluid">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="gallery-item">
                                <a href="{{ asset('landing/assets/img/gallery/6.jpg') }}" class="galelry-lightbox">
                                    <img src="{{ asset('landing/assets/img/gallery/6.jpg') }}" alt=""
                                        class="img-fluid">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="gallery-item">
                                <a href="{{ asset('landing/assets/img/gallery/7.jpg') }}" class="galelry-lightbox">
                                    <img src="{{ asset('landing/assets/img/gallery/7.jpg') }}" alt=""
                                        class="img-fluid">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="gallery-item">
                                <a href="{{ asset('landing/assets/img/gallery/8.jpg') }}" class="galelry-lightbox">
                                    <img src="{{ asset('landing/assets/img/gallery/8.jpg') }}" alt=""
                                        class="img-fluid">
                                </a>
                            </div>
                        </div>
