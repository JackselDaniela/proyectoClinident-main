                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form action="{{ route('Personalizar.store') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input name="nom_website" class="form-control" placeholder="Indique" type="text"
                                        required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2">
                                    <div class="img-thumbnail float-right"><img src="assets/img/logo-dark.png"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2">
                                    <div class="settings-image img-thumbnail float-right"><img src="assets/img/favicon.ico"
