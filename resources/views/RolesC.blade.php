...
@section('title')
    <title>Clinident / Registrar Rol</title>
@endsection
        ...
        <div class="content">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ asset('Roles.create') }}">Nuevo Rol</a></li>
                </ol>
            </nav>
            <section>
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <h4 class="page-title text-center" style="padding-bottom: 4rem">Nuevo Rol</h4>
