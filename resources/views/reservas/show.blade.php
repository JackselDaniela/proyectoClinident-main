...
@section('contenido')
    <div class="page-wrapper">
        <div class="content">
            ...
            <section style="padding-top: 5rem; position: relative;">
                <div class="col-sm-2 col-12"
                    style="margin-top: 1rem; position: absolute; top: 0; right: 0; z-index: 9999px">
                    <div class="btn-group btn-group-sm">

                        <a href="{{ route('reservasCodigoPDF', $reserva->id) }}" target="_blank" class="btn btn-white"><img
                    ...
                    <div class="col-sm-6">
                        <div class="card-box border border-gray">
                            <div class="card-block">
                                ...
                                <a href="{{ route('RutaT.editar', $reserva->paciente_diagnostico->id) }}"
                                    class="block text-center mb-3">{{ $reserva->tratamiento }}</a>
                                <ul class="list-group">
